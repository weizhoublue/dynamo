...
你可以启用 **xgrammar 结构化标签**，让引导式解码在 token 粒度上匹配解析器的工具调用格式。参阅 [Structural tag (guided decoding for tool calls)](https://github.com/ai-dynamo/dynamo/blob/1f74ef8c204ed6e283c22374f2b8c5cc83bf7b52/docs/tool-calling/structural-tag.md)。
