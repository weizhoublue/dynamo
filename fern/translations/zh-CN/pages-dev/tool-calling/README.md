...
你可以启用 **xgrammar 结构化标签**，让引导式解码在 token 粒度上匹配解析器的工具调用格式。参阅 [Structural tag (guided decoding for tool calls)](https://github.com/ai-dynamo/dynamo/blob/daf44c6bf194ae7c56961b14f6cfa7edfe25af28/docs/tool-calling/structural-tag.md)。
