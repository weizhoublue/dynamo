...
有关流程级细节，请参阅 [Architecture Flow](/dynamo/dev/knowledge-base/concepts/system-architecture/architecture-flow)。
有关请求传输选项，请参阅 [Request Plane](/dynamo/dev/knowledge-base/concepts/communication-planes/request-plane)。
...
Planner 支持基于吞吐量和基于负载的策略。请参阅 [Planner 设计](/dynamo/zh-CN/dev/knowledge-base/modular-components/planner/planner-design)。
...
- [Planner 设计](/dynamo/zh-CN/dev/knowledge-base/modular-components/planner/planner-design)
